...
public class SlidingTabLayout extends HorizontalScrollView {
     ...
     */
    public void setViewPager(ViewPager viewPager, int id) {
     ...
     */
    protected TextView createDefaultTabView(Context context, int id) {
    ...
    public void changeColor(Context context, int id) {
        textView.setTextColor(ContextCompat.getColor(context, R.color.textColorLight));
        ;
    }

    private void populateTabStrip(int id) {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (tabView == null) {
                tabView = createDefaultTabView(getContext(), id);
            }
